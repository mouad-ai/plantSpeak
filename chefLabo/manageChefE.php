<?php
 ...
 if(isset($_POST['modifier'])){
      $sql = "UPDATE personne
         ...
         img = '".$_POST['img_url']."'
         where PersonneID = ".$_POST['idC']."
      ";
      mysqli_query($lien, $sql) or die(mysqli_error($lien));
   }
 if(isset($_POST['supprimer']) && isset($_POST['idC'])){
      $sql = "DELETE FROM chefequipe where ChefID=". $_POST['idC'];
      $sql1 = "DELETE FROM personne where PersonneID=". $_POST['idC'];
      mysqli_query($lien, $sql) or die(mysqli_error($lien));
...
if(isset( $_POST['ajouter'])  && isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['mdp']) && isset($_POST['img_url'])){
      ...
      $sql1= 'insert into chefequipe (ChefID) VALUES ('.$last_id.')';
      mysqli_query($lien, $sql1) or die(mysqli_error($lien));
   }